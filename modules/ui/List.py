...
class List(wx.ListView, listmix.ListCtrlAutoWidthMixin):
    def __init__(self, parent, id=-1, columns=[], style=wx.LC_REPORT):
        wx.ListView.__init__(self, parent, id, style=style)
...
class CheckList(CheckListMixin, List):
    def __init__(self, parent, id=-1, columns=[], check_image=None, uncheck_image=None, style=wx.LC_REPORT):
        List.__init__(self, parent, id, columns, style=style)
